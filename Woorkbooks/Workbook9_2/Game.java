...
public class Game {
    ...
    public void begin(Team home, Team away) {
        ...
        System.out.println(
            ...
            "; at shooting guard, " + home.getPlayer(SHOOTING_GUARD) +
            "; at small forward, " + home.getPlayer(SMALL_FORWARD) +
            "; at power forward, " + home.getPlayer(POWER_FORWARD) +
            "; at center, " + home.getPlayer(CENTER) + "." +
            "\n\n - The starting lineup for the visiting team is: at point guard, " + away.getPlayer(POINT_GUARD) +
            "; at shooting guard, " + away.getPlayer(SHOOTING_GUARD) +
            "; at small forward, " + away.getPlayer(SMALL_FORWARD) +
            "; at power forward, " + away.getPlayer(POWER_FORWARD) +
            "; at center, " + away.getPlayer(CENTER) + "." +
